...
public class FindTest
{
    ...
    {
        for(int i = 0; i < FIND_TESTS.Length; i++)
        {
            var test = FIND_TESTS[i];
            TestFindUTF8(test);
        }
    }
    ...
    public void TestFindUTF8SubmatchIndex()
    {
        ...
        {
            var test = FIND_TESTS[i];
            TestFindUTF8SubmatchIndex(test);
        }
    }
